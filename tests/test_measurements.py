...
from pxmcmc.utils import mw_sample_length, mw_sample_positions


def test_pathintegral_dot(L):
    pathmatrix = sparse.random(100, mw_sample_length(L))
    ...
    x = pyssht.inverse(xlm, L, Reality=True).flatten()
